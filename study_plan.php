    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="study_plan.php" class="nav-item nav-link active">Lộ trình học</a>
                ...
                <?php if ($currentUser): ?>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2">
                            ...
                            <li><a class="dropdown-item" href="study_plan.php"><i class="fas fa-fire me-2 text-warning"></i>Chuỗi học: <?php echo (int) $streakStatus['currentStreak']; ?> ngày</a></li>
                            <?php if ($role === 1): ?>
